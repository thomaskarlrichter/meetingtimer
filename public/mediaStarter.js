...
function createOverlays() {
  var topHat = gapi.hangout.av.effects.createImageResource(
      'http://meetingtimer.meteor.com/topHat.png');
  ...
  var mono = gapi.hangout.av.effects.createImageResource(
      'http://meetingtimer.meteor.com/monocle.png');
  ...
  var stache = gapi.hangout.av.effects.createImageResource(
      'http://meetingtimer.meteor.com/mustache.png');
...
var gooddaySoundURL =
    'http://meetingtimer.meteor.com/goodday.wav';
